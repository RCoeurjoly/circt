...
static Value createFloatLiteral(RTLBuilder &s, Location loc, FloatAttr value) {
  ...
  std::string format =
      std::to_string(floatType.getWidth()) + "'h" + std::string(hex);
...
static LogicalResult convertFuncOp(ESITypeConverter &typeConverter,
  ...
  patterns.insert<
      ...
      UnitRateConversionPattern<arith::DivUIOp, comb::DivUOp>,
      UnitRateConversionPattern<arith::DivSIOp, comb::DivSOp>,
