...
// CHECK: hw.module.extern @circt_fp_clampf_f32{{.*}}sv.attributes = [#sv.attribute<"blackbox">]
// CHECK: hw.module.extern @circt_fp_isfinite_f32{{.*}}sv.attributes = [#sv.attribute<"blackbox">]
// CHECK: hw.module.extern @circt_fp_isinf_f32{{.*}}sv.attributes = [#sv.attribute<"blackbox">]
// CHECK: hw.module.extern @circt_fp_isnan_f32{{.*}}sv.attributes = [#sv.attribute<"blackbox">]
// CHECK: hw.module.extern @circt_fp_isnormal_f32{{.*}}sv.attributes = [#sv.attribute<"blackbox">]
...
// CHECK: hw.instance "u_fp" @circt_fp_clampf_f32
// CHECK: hw.instance "u_fp" @circt_fp_isfinite_f32
// CHECK: hw.instance "u_fp" @circt_fp_isinf_f32
// CHECK: hw.instance "u_fp" @circt_fp_isnan_f32
// CHECK: hw.instance "u_fp" @circt_fp_isnormal_f32
// CHECK-NOT: $itor
...
handshake.func @test_fp_binary_math(%ctrl: none, ...) -> (f32, f32, f32, f32, f32, i1, i1, i1, i1) {
  ...
  %clamp = math.clampf %af#4 to [%bf#5, %bf#6] : f32
  %isf = math.isfinite %af#5 : f32
  %isi = math.isinf %af#6 : f32
  %isn = math.isnan %bf#7 : f32
  %isnorm = math.isnormal %bf#8 : f32
  return %atan2, %powf, %fma, %cpy, %clamp, %isf, %isi, %isn, %isnorm : f32, f32, f32, f32, f32, i1, i1, i1, i1
}
