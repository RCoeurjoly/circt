...
handshake.func @test_fp_ops(%ctrl: none, ...) -> (f32, f32, f32, f32, f32, f32, f32, f32, f32, f32) {
  ...
  %exp = math.exp %c0f#5 : f32
  %rsq = math.rsqrt %c0f#6 : f32
  %tanh = math.tanh %c0f#7 : f32
  %pow = math.fpowi %c0, %ce : f32, i64
  %tr = arith.truncf %c2 : f64 to f32

  return %add, %sub, %mul, %div, %max, %exp, %rsq, %tanh, %pow, %tr : f32, f32, f32, f32, f32, f32, f32, f32, f32, f32
}
